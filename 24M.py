    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://api.whatsapp.com/send?phone=+6287881145568&text=Halo%20Admin%20semoga%20harimu%20Order%20menyenangkan^-^')
                time.sleep(2)
                menu()
