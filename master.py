                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            ...
                            if zedd == '6':
                                os.system('rm -rf login.txt')
				os.system('https://api.whatsapp.com/send?phone=62813764416650&text=SEMOGA%0AHARI%0AMENYENANGKAN%0AADMIN%0A:}')
                                keluar()
                            else:
                                if zedd == '0':
                                    keluar()
